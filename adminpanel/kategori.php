    ...
    <div style="padding-top:5rem;" class="container mt-5">
        ...
        <div class="my-5 col-12 col-md-6">
            ...
            <form action="" method="post">
                ...
                <div class="mt-3">
                    <button style="background-color: #043873;" class="btn btn-primary" type="submit" name="simpan_kategori">Simpan</button>
                </div>
            </form>
            <?php
                    ...
                    <tbody>
                        ...
                        ?>
                                    <tr>
                                        ...
                                        <td>
                                            <a style="background-color: #043873;" href="kategori-detail.php?p=<?php echo $data['id']; ?>" class="btn btn-info"><i style="color: white;" class="fas fa-search"></i></a>
                                        </td>
